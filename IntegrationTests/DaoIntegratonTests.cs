...
public class DaoIntegrationTests
{
    ...
    private readonly Dao _dao = new Dao("Server=thevillagecc.database.windows.net,1433;Database=thevilla_scorebook;Uid=thevillagecc_admin;Password=JVbB7ujECUxS2tm;Provider='SQLOLEDB';");
