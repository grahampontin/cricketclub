...
namespace CricketClub.Tests
{
    public abstract class IntegrationTestSupport
    {
        ...
        public void Init()
        {
            ...
            if (string.IsNullOrEmpty(Environment.GetEnvironmentVariable("Database_ConnectionString")))
            {
                ...
                Environment.SetEnvironmentVariable("Database_ConnectionString", testConnectionString);
